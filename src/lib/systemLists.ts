...
// "800 Greatest Movies" — a user-supplied curated ranking (rank 1 first,
// same convention as the other ranked lists above), not tied to any external
// site's own list.
const GREATEST_800_LIST: { title: string; year: number }[] = [
  { title: "Psycho", year: 1960 },
  { title: "2001: A Space Odyssey", year: 1968 },
  { title: "Schindler's List", year: 1993 },
  { title: "GoodFellas", year: 1990 },
  ...
  { title: "Rosemary's Baby", year: 1968 },
  { title: "Isle of Dogs", year: 2018 },
  { title: "My Life as a Dog", year: 1985 },
  { title: "Pierrot le Fou", year: 1965 },
  { title: "Sound of Metal", year: 2019 },
  ...
  { title: "Wings of Desire", year: 1987 },
  { title: "House", year: 1977 },
  { title: "Seven Psychopaths", year: 2012 },
  { title: "In a Lonely Place", year: 1950 },
  { title: "The Young Girls of Rochefort", year: 1967 },
  { title: "Suddenly, Last Summer", year: 1959 },
  { title: "Terms of Endearment", year: 1983 },
  ...
  { title: "Children of Heaven", year: 1997 },
  { title: "Planet of the Apes", year: 1968 },
  { title: "The Spanish Apartment", year: 2002 },
  { title: "Godzilla Minus One", year: 2023 },
  { title: "Flipped", year: 2010 },
  ...
  { title: "Hero", year: 2002 },
  { title: "Blood In, Blood Out", year: 1993 },
  { title: "Beau Travail", year: 1999 },
  { title: "Running on Empty", year: 1988 },
  { title: "Sidewalls", year: 2011 },
  ...
  { title: "Sideways", year: 2004 },
  { title: "A Man Called Ove", year: 2015 },
  { title: "Field of Dreams", year: 1989 },
  { title: "Robot Dreams", year: 2023 },
  { title: "The Shop Around the Corner", year: 1940 },
  { title: "Kwaidan", year: 1964 },
...
const GREATEST_800_LIST_KEY = "800-greatest-movies";
const GREATEST_800_LIST_TITLE = "800 Greatest Movies";
const GREATEST_800_LIST_DESCRIPTION = "A curated ranking of the 800 greatest movies.";
...
async function seedGreatest800List() {
  const list = await claimSystemList(
    GREATEST_800_LIST_KEY,
    GREATEST_800_LIST_TITLE,
    GREATEST_800_LIST_DESCRIPTION
  );
  if (!list) return;

  const resolved = await resolveTitleYearList(GREATEST_800_LIST);
...
export async function ensureSystemLists() {
  ...
  if (!existingKeys.has(GREATEST_800_LIST_KEY)) await seedGreatest800List();
